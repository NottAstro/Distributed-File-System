 ...
 * ──────────────────────────────────────────────────
 * Sets up: HTML <head> (title, meta, fonts, favicon),
 * React Query provider, DFS state provider, toast
 * notifications, 404 page, and error page.
 *
 * DO NOT RENAME this file — TanStack Router requires
 * it to be named "__root.tsx".
 * ──────────────────────────────────────────────────
 */
  ...
  head: () => ({
    meta: [
      ...
      { title: "upLoader — Distributed File Storage" },
      {
        name: "description",
        content:
          "Split, encrypted and distributed file storage. Upload once, retrieve from anywhere.",
      },
